...
from tkinter import ttk #import tkk() widget
...
#2. entry nama depan
nama_depan_entry = ttk.Entry(input_frame, textvariable=NAMA_DEPAN) #entry akan masuk constant NAMA_DEPAN
