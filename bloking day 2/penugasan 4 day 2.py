...
class Square(Shape):
    ...
    # Definiskan kelas turunan Circle yang mewarisi Shape
    class Circle(Shape):
...
# Definisikan kelas turuban Triangle yang mewarisi dari Shape
class Triangle(Shape):
    ...
    def hitung_luas(self);
        return 0.5 * self.atas * self.tinggi
